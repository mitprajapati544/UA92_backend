...
<body>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item active" aria-current="page" href="view_teacher.php">View
                                    Teacher</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
    ...
    <div class="container-fluid">
        ...
        <div class="form">
            ...
            <h4 class="h4">View All Teacher</h4></br>
            <div class="container text-center" style="margin-left: 90px;">
                ...
                <table>
                    ...
                    <hr>
                        ...
                        <th width="150px">Annual Salary</br>
                    <hr>
                    </th>
                        <th width="190px">Background Check</br>
                    <hr>
                    </th>
                    ...
                    $sql = mysqli_query($link, "SELECT Teacher_ID, Teacher_FName, Teacher_LName, Tgender, Address, Contact_Number, Email, Annual_Salary, Background_Check, Date_Of_Birth FROM teacher");
