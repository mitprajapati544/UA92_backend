    ...
    <mata value="keywords" data="">
        ...
        <script>
            function validation() {
                ...
                if (cname.value == "" || rnumber.value == "" || ccapacity.value == "" || cnumber.vlaue == "") {
...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO classes(Class_Name, Room_number, Class_Capacity, Teacher_ID) VALUES ('$cname', '$rnumber', '$ccapacity', '$Teacher')";
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="add_parents.php">Add
                                    Parents</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item active" aria-current="page" href="add_class.php">Add class</a>
                            </li>
    ...
    <div class="container-fluid">
        ...
        <div id="form" class="container">
            <div class="form">
                <h4 class="h4">Add Class</h4>
                <marquee>
                    <h6 class="h6">For Adding Class, You need to fill all the required fields</h6>
                </marquee>
                <form id="form" action="add_class.php" method="post">
                    <div id="inner-form" class="container">

                        <input class="form" name="cname" type="text" placeholder="Enter Class Name"
                            required /></br></br>

                        <input class="form" name="rnumber" type="text" placeholder="Enter Room Number"
                            required /></br></br>

                        <input class="form" name="ccapacity" type="text" placeholder="Enter Class Capacity"
                            required /></br></br>


                    </div>

                    <p id="dob">Select Class Teacher</p>
                    <select name="Teacher">

                        <?php

                        $sql = mysqli_query($link, "SELECT Teacher_ID, Teacher_FName, Teacher_LName FROM teacher");
                        while ($row = $sql->fetch_assoc()) {
                            echo "<option value='{$row['Teacher_ID']}'>{$row['Teacher_ID']} {$row['Teacher_FName']} {$row['Teacher_LName']}</option>";
                        }
