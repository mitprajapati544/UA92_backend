...
<body>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item active" aria-current="page" href="view_parents.php">View
                                    Parents</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
    ...
    <div class="container-fluid">
        ...
        <div class="form">
            ...
            <h4 class="h4">View All Parents</h4></br>
            <div class="container text-center" style="margin-left: 110px;">
                ...
                <table>
                    ...
                    <hr>
                        ...
                        <th width="200px">First Name</br>
                    <hr>
                    </th>
                        <th width="200px">Last Name</br>
                    <hr>
                    </th>
                        <th width="200px">Gender</br>
                    <hr>
                    </th>
                    ...
                    $sql = mysqli_query($link, "SELECT Pid, PFname, PLname, Pgender, Pemail, Pnumber FROM parents");
