...
<body>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="view_classes.php">View
                                    Classes</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item active" aria-current="page" href="view_library.php">View
                                    Library</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container-fluid">
        ...
        <div class="form">
            <h4 class="h4">View All Library Members</h4></br>

            <div class="container text-center" style="margin-left:400px;">
                <table id="tbl">
                    <tr>

                        <th width="150px">Library ID</br>
                            <hr>
                        </th>
                        <th width="150px">Student ID</br>
                            <hr>
                        </th>
                        <th width="150px">Taken Books</br>
                            <hr>
                        </th>
                        <th width="150px">Membership </br>
                            <hr>
                        </th>
                    ...
                    $sql = mysqli_query($link, "SELECT Library_ID, Student_ID, Taken_books, Taken_membership FROM library");
                    while ($row = $sql->fetch_assoc()) {
                        echo "
                     <tr>
				<td>{$row['Library_ID']}</td>
				<td>{$row['Student_ID']}</td>
				<td>{$row['Taken_books']}</td>
				<td>{$row['Taken_membership']}</td>
                 </tr>";
                    }
                    ?>
                </table>
